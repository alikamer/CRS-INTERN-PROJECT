  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-3">
        <div>
          <h1 className="text-2xl font-bold text-[#1F1F1F] tracking-tight">{data.tenantName}</h1>
          <p className="text-sm text-[#5E5E5E] mt-1">
            B2B fiş işleme metrikleri ve harcama analizi
            <span className="text-sm text-[#747775] ml-2">· Son 30 gün · {data.subscriptionPlan} Paket</span>
          </p>
        </div>
      </div>
      ...
      <div className="ga4-card p-6">
        <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-[#E1E3E1]">
          <div className="pb-4 md:pb-0 md:pr-6">
            ...
            <p className="text-sm text-[#747775] mt-1">Onaylanmış dijital fişler</p>
          </div>
          <div className="py-4 md:py-0 md:px-6">
            ...
            <p className="text-sm text-[#747775] mt-1">Doğrulanmış ciro hacmi</p>
          </div>
          <div className="pt-4 md:pt-0 md:pl-6">
            <p className="text-sm text-[#5E5E5E] mb-1">Ortalama Sepet Tutarı</p>
            <p className="text-3xl font-bold text-[#1F1F1F] tracking-tight">
              ₺{Number(data.averageBasketAmount).toLocaleString('tr-TR', { minimumFractionDigits: 2 })}
            </p>
            <p className="text-sm text-[#747775] mt-1">Fiş başına düşen harcama</p>
          </div>
        </div>
      </div>
